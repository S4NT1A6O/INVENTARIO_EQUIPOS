...
class controladorItems{
    ...
    public function RegistroItem(){
        ...
        if ($_POST) {
            ...
            modeloItem::setItem($MARCA_PC,$MODELO_PC,$SERIAL_PC,$PROCESADOR_PC,$RAM_PC,$UNIDAD_RAM_PC,$ALMACENAMIENTO_PC,$UNIDAD_ALMACENAMIENTO_PC,$TIPO_SISTEMA_PC,$SISTEMA_OPERATIVO_PC,$VERSION_SO_PC,$DISPONIBILIDAD_PC,$ESTADO,$CREATED_AT,$UPDATED_AT);
