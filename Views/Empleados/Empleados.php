                ...
                <table id="employeesTable" class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php foreach ($empleados as $empleado) { ?>
                            <tr>
                                <th scope="row" style="font-size: small;">
                                    <?php echo $empleado->ID_USUARIO ?>
                                </th>
                                <td style="font-size: small;">
                                    <?php echo $empleado->ID_EMPRESA_FK ?>
                                </td>
                                <td style="font-size: small;">
                                    <?php echo $empleado->NOMBRE_COMPLETO_USUARIO ?>
                                </td>
                                <td style="font-size: small;">
                                    <?php echo $empleado->CORREO_USUARIO ?>
                                </td>
                                <td style="font-size: small;">
                                    <?php echo $empleado->TIPO_DOCUMENTO_USUARIO . " " .  $empleado->NUMERO_DOCUMENTO_USUARIO ?>
                                </td>
                                <td style="font-size: small;">
                                    <?php echo $empleado->FECHA_NACIMIENTO_USUARIO ?>
                                </td>
                                <td style="font-size: small;">
                                    <?php echo $empleado->NUMERO_CELULAR_USUARIO ?>
                                </td>
                                <td style="font-size: small;">
                                    <?php echo $empleado->NUMERO_FIJO_USUARIO ?>
                                </td>
                                <!-- btn's acciones -->
                                <td>
