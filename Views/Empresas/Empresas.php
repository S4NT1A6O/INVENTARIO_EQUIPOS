                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                            <table id="companyTable" class="table table-striped table-hover" style="font-size: small;">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <?php foreach($empresas as $empresa){?>
                                                        <tr>
                                                            <!-- datos -->
                                                            <th scope="row" style="font-size: small;  max-height: 20px;"><?php echo $empresa->ID_AREA_EMPRESA; ?></th>
                                                            <td style="font-size: small;  max-height: 50px;"><?php echo $empresa->NOMBRE_AREA_EMPRESA; ?></td>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Inventario Prestamos 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
