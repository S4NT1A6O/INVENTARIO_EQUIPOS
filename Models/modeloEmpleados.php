...
class modeloEmpleados
{
    ...
    public static function selectDataEmpresa()
    {
        ...
        $sql = "SELECT ID_AREA_EMPRESA, NOMBRE_AREA_EMPRESA 
                FROM AREA_EMPRESA 
                WHERE ESTADO = 'ACTIVO';";
    ...
    public static function existEmployee($numDoc, $email)
    {
        $conexionDB = connectionDB::crearInstancia();
        $sql = "SELECT 1
                FROM USUARIO 
                WHERE CORREO_USUARIO = '{$email}' OR NUMERO_DOCUMENTO_USUARIO = '{$numDoc}'";
        $stmt = $conexionDB->prepare($sql);
        $stmt->execute();
    ...
    public static function setEmpleado(
        ...
        $conexionDB = connectionDB::crearInstancia();
        $sql = $conexionDB->prepare("INSERT INTO USUARIO (ID_EMPRESA_FK, NOMBRE_COMPLETO_USUARIO , CORREO_USUARIO, TIPO_DOCUMENTO_USUARIO, NUMERO_DOCUMENTO_USUARIO, FECHA_NACIMIENTO_USUARIO, NUMERO_CELULAR_USUARIO, NUMERO_FIJO_USUARIO, ESTADO, CREATED_AT, UPDATED_AT) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public static function deleteEmpleado($ID_EMPLEADO)
    {
        ...
        $conexionDB = connectionDB::crearInstancia();
        $sql = $conexionDB->prepare("UPDATE USUARIO SET ESTADO = 'INACTIVO' WHERE ID_USUARIO = ?;");
